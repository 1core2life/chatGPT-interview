...
class ChatGPTInterview():
    ...
    def start_interview(self):
        ...
        messages = [{"role": "system", "content": "I want you to act as an {0} tech interviewer.\
                    ...
                    Speak language only korean. Do not speak english".format(self.job[self.job_input], self.job[self.job_input])}]
